# -*- coding: utf-8 -*-
"""
Created on Sun Aug  1 05:58:17 2021
...
log_y_train_predprob = clf.predict_proba(x_train)
log_y_test_predprob = clf.predict_proba(x_cv_)

# plot results on train set
roc_auc = plot_roc_cm(y_train, log_y_train_predprob[:,-1])
print("Train auc score: ", roc_auc)

# plot results on valid set
roc_auc = plot_roc_cm(y_cv, log_y_test_predprob[:,-1])
